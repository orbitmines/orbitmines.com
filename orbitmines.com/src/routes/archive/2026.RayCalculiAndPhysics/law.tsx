/**
 * THE PAGE COMPONENTS that were the bottom half of this file. The notation they are
 * written in now lives in `Physics/LAW.tsx`; these still render the archive panels,
 * so they stay here until those are ported.
 */
...
import {
  B, Bar, Because, CEILING, CLOCK, COHERENT, CONSTANTS, D, Derivation, Eq, F, Frac,
  FULL, Hat, Head, IDENTICAL, IGNORANCE, K, LAW, MADE_FROM, MEETINGS, MET, METRIC,
  Note, Panel, Paren, R, REACH, RECORD, Rows, SPACE, Step, Sub, Sup, TURNS, Type, V,
} from "../../Physics/LAW";
