...
const orbitmines_icon = "/organizations/orbitmines/icon/orbitmines.icon.650x650.png";
const minigames_icon = "/organizations/orbitmines/minecraft/server/icon/orbitmines.minecraft.server.icon.minigames.1000x1000.png";
const creative_icon = "/organizations/orbitmines/minecraft/server/icon/orbitmines.minecraft.server.icon.creative.1000x1000.png";
const prison_icon = "/organizations/orbitmines/minecraft/server/icon/orbitmines.minecraft.server.icon.prison.1000x1000.png";
const strangeloop_icon = "/organizations/strange-loop/strange_loop_logo_final_color_no_year_square2.png";
const semf_icon = "/organizations/semf/semf_icon.jpg";
const ursprung_icon = "/organizations/ursprung/ursprung_icon.png";
const webassembly_icon = "/organizations/wasm/webassembly-icon.png";
const topos_institute_icon = "/organizations/topos.institute/topos_favicon.ico";
const mindscape_icon = "/organizations/preposterous-universe/download.jpeg";
const criticalthinking_icon = "/organizations/critical-thinking/https___s3.us-west-1.amazonaws.com_redwood-labs_showpage_uploads_images_403b35d6-ec76-4cd9-a70d-bd1c5d825460.png";
const hoc_icon = "/organizations/hoc/92327702.png";
const mlst_icon = "/organizations/mlst/channels4_profile.jpg";
const ngi_icon = "/organizations/ngi/Logo-NGI_Icon-circle-NGI-rgb.png";
const santa_fe_icon = "/organizations/santa-fe-institute/0_OgRM7UU-SsqK46La.png";
const papers_we_love_icon = "/organizations/papers-we-love/6187757.png";
const wolfram_institute_icon = "/organizations/wolfram-institute/channels4_profile.jpg";
const tinycorp_icon = "/organizations/tinycorp/132956020.jpeg";
const lex_fridman_podcast_icon = "/organizations/lexfridman-podcast/download.jpeg";
const _3b1b_icon = "/organizations/3b1b/3B1B_Logo.svg.png";
const akissinger_icon = "/organizations/akissinger/881183.png";
const wolfram_icon = "/organizations/wolfram-research/logo.png";
const all_in_icon = "/organizations/all-in/icon.jpeg";
const zx_calculus_icon = "/organizations/zx/icon.png";
const active_inference_institute_icon = "/organizations/active-inference-institute/channels4_profile.jpg";
const toe_icon = "/organizations/toe/toe.jpg";
