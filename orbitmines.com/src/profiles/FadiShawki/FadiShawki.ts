import ORGANIZATIONS, {Content, ContentCategory, Viewed} from '../../lib/organizations/ORGANIZATIONS';
...
// TODO , Accurate here, list the articles from archive automatically
  ...
  GITLAB: <Content>{reference: {title: "GitLab", link: "https://en.wikipedia.org/wiki/GitLab"}, status: Viewed.VIEWED},
  GITHUB: <Content>{reference: {title: "GitHub", link: "https://en.wikipedia.org/wiki/GitHub"}, status: Viewed.VIEWED},
  BITBUCKET: <Content>{
